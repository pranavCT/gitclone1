...
<section class="col-lg-12">
    <div class="row">
        <div class="page-title text-blue p-15">Course Management&nbsp;<label style="color:#000;font-size:14px;margin-left:5px;">Edit Course</label>
            <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="col-lg-12">
                <form id="update_course" class="mt-20" action="{{ url('admin/update-course') }}/{{ $data['course_details']['id'] }}" method="post">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Title&nbsp;<small class="text-danger">*</small></label>
                            <input type="text" name="title" value="{{ $data['course_details']->title }}" class="form-control">
